 ...
 */
@Service
public class SysJobLogServiceImpl extends BaseServiceImpl<SysJobLog, SysJobLogMapper> implements ISysJobLogService, JobLogService
{
    @Autowired
    ...
    public void addJobLog(IJobLog jobLog)
    {
        ...
        BeanUtils.copyProperties(jobLog,sysJobLog);
