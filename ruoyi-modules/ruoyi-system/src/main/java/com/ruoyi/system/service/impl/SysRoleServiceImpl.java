...
public class SysRoleServiceImpl extends BaseServiceImpl<SysRole, SysRoleMapper> implements ISysRoleService
{
     ...
     */
    @Override
    public PageData<SysRole> selectRolePage(SysRole role)
    {
        return SpringUtils.getAopProxy(this).selectPage(role);
    }

    @Override
    public List<SysRole> selectRoleList(SysRole role)
    {
        return SpringUtils.getAopProxy(this).selectList(role);
    }
    ...
    {
        List<SysRole> userRoles = this.getBaseMapper().selectRolePermissionByUserId(userId);
    ...
    public boolean checkRoleNameUnique(SysRole role)
    {
        ...
        SysRole info = this.getBaseMapper().checkRoleNameUnique(role.getRoleName());
    ...
    {
        Long roleId = StringUtils.isNull(role.getRoleId()) ? -1L : role.getRoleId();
        SysRole info = this.getBaseMapper().checkRoleKeyUnique(role.getRoleKey());
        if (StringUtils.isNotNull(info) && info.getRoleId().longValue() != roleId.longValue())
        {
            return UserConstants.NOT_UNIQUE;
        }
    ...
    public void checkRoleDataScope(Long... roleId)
    {
        ...
        {
            List<SysRole> roles = SpringUtils.getAopProxy(this).listByIds(Arrays.asList(roleId));
    ...
    {
        return this.getBaseMapper().updateById(role);
    }
    ...
    public int insertRoleDept(SysRole role)
    {
        ...
        if (list.size() > 0)
        {
            ...
            dictService.reloadData(DictSpace.RoleDept);
        }
        return rows;
    }
    ...
    public int deleteRoleById(Long roleId)
    {
        ...
        int row = this.getBaseMapper().deleteRoleById(roleId);
    ...
    public int deleteRoleByIds(Long[] roleIds)
    {
        ...
        int row = this.getBaseMapper().deleteRoleByIds(roleIds);
