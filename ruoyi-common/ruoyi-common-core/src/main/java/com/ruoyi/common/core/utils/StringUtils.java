...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    public static Set<Long> toLongSet(String str) {
        return toLongSet(str, ",");
    }

    public static Set<Long> toLongSet(String str, String spliter) {
        Set<Long> strs = new LinkedHashSet<>();
    ...
    public static Set<Integer> toIntSet(String str, String spliter) {
        Set<Integer> strs = new LinkedHashSet<>();
        if (StringUtils.isNotBlank(str)) {
            String[] parts = str.split(spliter);
            for (String part : parts) {
                if (part == null) {
