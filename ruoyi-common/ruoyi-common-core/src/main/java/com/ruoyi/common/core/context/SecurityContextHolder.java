...
public class SecurityContextHolder
{
    ...
    public static Boolean isIgnoreTenantId() {
        return Convert.toBool(get(SecurityConstants.IGNORE_TENANT_ID), false);
    }

    public static void ignoreTenantId() {
        set(SecurityConstants.IGNORE_TENANT_ID, true);
    }

    public static String getApplicationName()
    {
        return get(SecurityConstants.APPLICATION_NAME);
    }

    public static void setApplicationName(String applicationName)
    {
        set(SecurityConstants.APPLICATION_NAME, applicationName);
    }
